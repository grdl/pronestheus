...
func TestAllMetrics(t *testing.T) {
	...
	assert.Contains(t, w.Body.String(), `nest_mode_heat{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 1`)
	assert.Contains(t, w.Body.String(), `nest_mode_heatcool{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 0`)
	assert.Contains(t, w.Body.String(), `nest_mode_cool{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 0`)
	assert.Contains(t, w.Body.String(), `nest_mode_off{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 0`)
